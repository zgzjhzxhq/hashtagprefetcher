set term post eps enh color ", 46" size 15, 5 #eps color enh font ",30"
...
set style fill solid 0.7 border 0
...
plot "acc.dat" using 2:3:xtic(1) lt 1 lw 2 lc rgb "#0072BD" notitle #"Prediction Accuracy" #, \
